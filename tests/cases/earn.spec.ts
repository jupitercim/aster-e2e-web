...
test.describe.serial('AsterDEX - 赚取（Earn）', () => {
  ...
  // ========================================================
  test('Earn 页面正常加载，标题与策略列表可见', { tag: ['@P0', '@PROD'] }, async ({ loggedInPage: page }) => {
  ...
  // ========================================================
  test('赚取与生态系统 Tab 切换正常', { tag: ['@P0', '@PROD'] }, async ({ loggedInPage: page }) => {
  ...
  // ========================================================
  test('点击产品能进入详情', { tag: ['@P0', '@PROD'] }, async ({ loggedInPage: page }) => {
