// spec: specs/referral-test.plan.md
...
test.describe.serial('AsterDEX - 推荐码页面', () => {
  ...
  // 测试 1：页面标题存在且有效
  // ========================================================
  test('推荐码页面标题可见', { tag: ['@P0', '@PROD'] }, async ({ loggedInPage: page }) => {
  ...
  // 测试 2：推荐码文本可见
  // ========================================================
  test('推荐码文本可见', { tag: ['@P0', '@PROD'] }, async ({ loggedInPage: page }) => {
  ...
  // 测试 3：复制按钮存在
  // ========================================================
  test('复制按钮存在', { tag: ['@P0', '@PROD'] }, async ({ loggedInPage: page }) => {
