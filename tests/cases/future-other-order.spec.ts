...
test.describe.serial('AsterDEX - 期货其他委托（止盈止损 / 计划委托）', () => {
  ...
  // 测试 1：止盈止损限价委托下单
  // ========================================================
  test('止盈止损限价委托下单', { tag: ['@P0'] }, async ({ loggedInPage: page }) => {
  ...
  // 测试 2：取消止盈止损委托单
  // ========================================================
  test('取消止盈止损委托单', { tag: ['@P0'] }, async ({ loggedInPage: page }) => {
  ...
  // 测试 3：全部撤销（一键撤销所有委托）
  // ========================================================
  test('一键撤销所有委托单', { tag: ['@P0'] }, async ({ loggedInPage: page }) => {
  ...
  // 测试 4：TWAP 策略创建入口可用
  // ========================================================
  test('TWAP 策略创建入口可用', { tag: ['@P0'] }, async ({ loggedInPage: page }) => {
  ...
  // 测试 5：资金费率和倒计时信息可见
  // ========================================================
  test('页面顶部资金费率和倒计时信息格式正确', { tag: ['@P0'] }, async ({ loggedInPage: page }) => {
